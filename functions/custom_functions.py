...
def get_free_time_for_next_7day(part:int , duration:str):
    ...
    for i in range(len(days_list)):
        ...
        print(f'list_time_that_could_be_reserve \n{list_time_that_could_be_reserve}')
        ...
        print(f'array_all_time_slot_for_each_day \n{array_all_time_slot_for_each_day}')
    
        reserved_time_as_time_slot=find_consecutive_sequence(array_all_time_slot_for_each_day ,duration_as_time_slot)
        time_could_be_reserve = 'None'
        if reserved_time_as_time_slot not in [None , 'Null' , 'None']:
            print(f'duration_as_time_slot\n{duration_as_time_slot}')
            print(f'reserved_time_as_time_slot \n {reserved_time_as_time_slot}')
